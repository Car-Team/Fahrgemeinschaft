<?php
	...
	$sqlQuery = "SELECT c.ID, c.WallID, c.ReceiverID, c.SenderID, c.Textinput, c.Timestamp, u.name, u.picID FROM Comments c, Users u WHERE c.ReceiverID = '$viewProfileID' AND c.SenderID = u.ID ORDER BY c.Timestamp ASC";
