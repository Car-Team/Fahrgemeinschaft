...
header('Content-Type: text/javascript; charset=UTF-8');
	...
	$sqlQuery = "SELECT c.ID, c.WallID, c.ReceiverID, c.SenderID, c.Textinput, c.Timestamp, u.name, u.picID FROM Comments c, Users u WHERE c.SenderID = u.ID ORDER BY c.Timestamp ASC";
