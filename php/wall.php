<?php
	...
	$sqlQuery = "SELECT w.ID, w.ReceiverID, w.SenderID, w.Textinput, w.Timestamp, u.name FROM Walls w, Users u WHERE w.ReceiverID = '$viewProfileID' AND w.SenderID = u.ID ORDER BY w.Timestamp DESC";
